...
#ifdef MERGE_SORT
    MergeSort_TwoArray_TwoKey((int*)entries, (int*) data, N, 0, 1, 1, 1, sizeof(MultKeyEnt)/sizeof(int), data_sz);
#else
    BitonicSort_TwoArray_TwoKey((int*)entries, (int*) data, N, 0, 1, 1, 1, sizeof(MultKeyEnt)/sizeof(int), data_sz);
#endif
    printf("\n Sort done.\n");
