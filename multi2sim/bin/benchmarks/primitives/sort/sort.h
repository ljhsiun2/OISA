...
void MergeSort_General(int arr[], int N, int _block_sz, int key1_idx, int _dir1, int key2_idx, int _dir2);
...
void BitonicSort_Int(int arr[], int N, int _dir);
...
void BitonicSort_Block(int arr[], int N, int _dir, int _block_sz);

// Bitonic sort for an array of specific data structure, and sorting is done wrt two keys in asc/desc order
void BitonicSort_General(int arr[], int N, int _block_sz, int _key1_idx, int _dir1, int _key2_idx, int _dir2);
...
void BitonicSort_TwoArray(int arr_main[], int arr_aux[], int N, int _dir, int _block_sz_main, int _block_sz_aux);
