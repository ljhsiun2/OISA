...
//#define ENABLE_PRINT
//  Warning: this method is absolutely bogus, since rdtsc is running on "real hardware" not "simulator"
//  UNFLAG it only when running the program on real hardware (without -m32!!!)
